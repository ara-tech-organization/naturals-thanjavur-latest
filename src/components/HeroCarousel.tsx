  ...
  const slides = [
    {
      ...
      title: "Transform Your Look with Premium Hair & Skin Care",
      subtitle: "Where Luxury Meets Expertise – Book Your Appointment Today"
    },
    {
    ...
    subtitle: "Customized Styling for Every Occasion"
    },
    {
            ...
            >
              ...
              <div className="relative z-10 h-full flex items-center justify-center text-center text-white">
                <div className="max-w-4xl mx-auto px-4">
                  <h1 className=" font-forum text-5xl md:text-6xl font-bold mb-6 animate-fade-in">
                    {slide.title}
                  </h1>
